# Coverage report for the pipeline covr gate.
#
...
# is what answers the real question from .claude/rules/testing.md — whether
# any line this PR ADDED is untested. Cross-reference those line numbers
# against `git diff` to tell an added line from a pre-existing one.
#
