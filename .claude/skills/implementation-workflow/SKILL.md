...
# surveyreports Implementation Workflow

**Announce at start:** "Running implementation-workflow Stage N — [stage name]."

This skill governs implementation plan work for surveyreports. Three stages, always in order:
...
|---|---|
| "The plan is clear enough, Stage 2 would just nitpick" | Stage 2 catches missing error paths, wrong task order, and missing cross-design test coverage before code is written. |
